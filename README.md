...
- [Baselines](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md)
  - [Binding.IgnoreCase](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md#bindingignorecase)
  - [Binding.TargetName](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md#bindingtargetname)
  - [Binding.TargetType](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md#bindingtargettype)
  - [Configuration](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md#configuration)
  - [Rule.Include](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md#ruleinclude)
  - [Rule.Exclude](docs/concepts/PSRule/en-US/about_PSRule_Baseline.md#ruleexclude)
