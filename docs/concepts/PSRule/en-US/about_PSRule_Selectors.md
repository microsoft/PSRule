...
- [IsArray](about_PSRule_Expressions.md#isarray)
- [IsBoolean](about_PSRule_Expressions.md#isboolean)
- [IsDateTime](about_PSRule_Expressions.md#isdatetime)
- [IsInteger](about_PSRule_Expressions.md#isinteger)
- [IsNumeric](about_PSRule_Expressions.md#isnumeric)
...
An online version of this document is available at https://microsoft.github.io/PSRule/v2/concepts/PSRule/en-US/about_PSRule_Selectors/.
