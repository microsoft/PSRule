...
public sealed class FunctionTests : ContextBaseTests
{
    ...
    private ExpressionContext GetContext()
    {
        ...
        var context = new LegacyRunspaceContext(GetPipelineContext(option: GetOption(), sources: sources, optionBuilder: new OptionContextBuilder(GetOption(), null, null, null), resourceCache: GetResourceCache()));
        ...
        context.EnterTargetObject(run, new TargetObject(targetObject));
        return result;
    }
